CREATE TABLE [Sales].[SalesOrderHeader] (
    ...
    CONSTRAINT [FK_SalesOrderHeader_CreditCard_CreditCardID] FOREIGN KEY ([CreditCardID]) REFERENCES [Sales].[[Sales]].[CreditCardTest]]] ([CreditCardID]),
...
CREATE NONCLUSTERED INDEX [IDX_ShipDate_ASC]
    ON [Sales].[SalesOrderHeader]([ShipDate] ASC);
